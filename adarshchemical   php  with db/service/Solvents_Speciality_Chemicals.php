...
<!-- Mirrored from adarshchemical.in/service/Solvents_Speciality_Chemicals by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 08:34:24 GMT -->
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                    ...
                    <meta name="description" content="At Adarsh Chemical, we offer a comprehensive selection of solvents and specialty chemicals meticulously designed to meet the diverse needs of industries worldwide.">
        <title>Solvents, Speciality Chemicals</title>
...
<!-- End Navbar Area -->
    ...
    <div class="page-banner" style="background-image: url(../uploads/banner_service_detail.jpg)">
        ...
        <div class="text">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Solvents</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="sidebar">
                        <div class="widget">
                            ...
                            <div class="type-2">
                                <ul>
                                                                        <li>
                                        <img src="../uploads/service-7.jpg">
                                        <a href="Inorganic_chemicals.php">inorganic chemicals</a>
                                    </li>
                                                                        <li>
                                        <img src="../uploads/service-8.png">
                                        <a href="Fine_chemicals.php">Fine chemicals</a>
                                    </li>
                                                                        <li>
                                        <img src="../uploads/service-9.jpg">
                                        <a href="Solvents_Speciality_Chemicals.php">Solvents</a>
                                    </li>
                                                                        <li>
                                        <img src="../uploads/service-10.jpg">
                                        <a href="pharma_intermediates.php">Pharma intermediates</a>
                                    </li>
                                                                    </ul>
                            </div>
                        </div>

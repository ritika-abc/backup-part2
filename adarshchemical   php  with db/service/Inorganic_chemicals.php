...
<!-- Mirrored from adarshchemical.in/service/Inorganic_chemicals by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 08:34:23 GMT -->
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                    ...
                    <meta name="description" content="Adarsh Chemical offers a comprehensive range of high-quality inorganic chemicals tailored to meet the diverse needs of industries worldwide.">
        <title>Inorganic chemicals</title>
...
<!-- End Navbar Area -->
    ...
    <div class="page-banner" style="background-image: url(../uploads/banner_service_detail.jpg)">
        ...
        <div class="text">
            <h1>inorganic chemicals</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="../services.php">Services</a></li>
                    <li class="breadcrumb-item active" aria-current="page">inorganic chemicals</li>
                </ol>
            </nav>
        </div>
    </div>

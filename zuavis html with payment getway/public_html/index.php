        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3>Find your home need</h3>
                </div>
            </div>
        </div>
        <div class="row">
              <div class="column">
                  <a style="color:black; "href="https://zuavis.co.in/product-category.php?id=1&type=top-category">
                     <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/1455572939649.jpeg);"></div>
              ...
              <div class="column">
                  <a style="color:black; "href="https://zuavis.co.in/product-category.php?id=3&type=top-category">
                   <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/tastychickenmasala-TRIKTheRealIndianKitchenMasalas2.jpg);"></div>
                                <div class="overlay"></div>
                            </div>
              ...
              <div class="column">
                  <a style="color:black; "href="https://zuavis.co.in/product-category.php?id=4&type=top-category">
                   <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/raw-whole-spices.jpg);"></div>
                                <div class="overlay"></div>
                            </div>
                                <h4  class="text-center">Whole Spices</h4>
                      </div> 
                      </a>
             </div>
             
              <div class="column">
                  <a style="color:black; "href="https://zuavis.co.in/product-category.php?id=5&type=top-category">
                   <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/h-peanut-butter.jpg);"></div>
                                <div class="overlay"></div>
                            </div>
                                <h4  class="text-center">Peanut Butter</h4>
                      </div> 
                      </a>
             </div>
            </div>
...
<div class="product pt_70 pb_70">
 ...
 <div class="row">
               ...
               <?php
                    $statement = $pdo->prepare("SELECT tbl_product.p_id, tbl_product.p_name,tbl_product.p_featured_photo, tbl_product.p_current_price, tbl_product.p_qty, tbl_product_size.size_id, tbl_product_size.p_id, tbl_size.size_id, tbl_size.size_name FROM ((tbl_product_size INNER JOIN tbl_product ON tbl_product.p_id=tbl_product_size.p_id) INNER JOIN tbl_size ON tbl_size.size_id=tbl_product_size.size_id)WHERE p_is_featured=? AND p_is_active=? LIMIT 8 ");

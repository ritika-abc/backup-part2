        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="col-md-9">
                ...
                <div class="product product-cat hidemobile">
                    ...
                    <div class="row ">
                        ...
                        if($prod_count==0) {
                            ...
                            for($ii=0;$ii<count($final_ecat_ids);$ii++) {
                                $statement = $pdo->prepare("SELECT tbl_product.p_id, tbl_product.p_name,tbl_product.p_featured_photo, tbl_product.p_current_price, tbl_product.p_qty, tbl_product_size.size_id, tbl_product_size.p_id, tbl_size.size_id, tbl_size.size_name FROM ((tbl_product_size INNER JOIN tbl_product ON tbl_product.p_id=tbl_product_size.p_id) INNER JOIN tbl_size ON tbl_size.size_id=tbl_product_size.size_id)  WHERE ecat_id=? AND p_is_active=?");
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <div class="column item ">
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <h3><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?> (<?php echo $row['size_name']; ?>)</a></h3>
                                                <h4>
...
<div class="container">
    <div class="product product-cat hidedesktop">

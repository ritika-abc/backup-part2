...
--
-- Host: localhost
-- Generation Time: Apr 20, 2023 at 09:26 AM
...
CREATE TABLE `dynamic_pages` (
  ...
  `dynamic_page_slug` text COLLATE utf8mb4_unicode_ci,
  `dynamic_page_content` text COLLATE utf8mb4_unicode_ci,
...
(1, 'logo.png', 'favicon.png', 'login_bg.jpg', 'info@yourwebsite.com', '111-222-3456', 'Show', 'Show', 'Show', 'Show', 5, '3867D6', 'Important Links', 'Useful Links', 'Contact Information', 'Social Media', '1582 Progress, Mora, MN, 55051', 'contact@yourwebsite.com', '320-225-5131', 'Copyright 2022. Your Company Name. All Rights Reserved.', 'preloader.gif', 'Hide', 'Hide', 'UA-84213520-6', 'Show', '<script type=\"text/javascript\">\r\n    var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();\r\n    (function(){\r\n        var s1=document.createElement(\"script\"),s0=document.getElementsByTagName(\"script\")[0];\r\n        s1.async=true;\r\n        s1.src=\'https://embed.tawk.to/5a7c31ded7591465c7077c48/default\';\r\n        s1.charset=\'UTF-8\';\r\n        s1.setAttribute(\'crossorigin\',\'*\');\r\n        s0.parentNode.insertBefore(s1,s0);\r\n    })();\r\n</script>', 'Show', 'This website uses cookies to ensure you get the best experience on our website.', 'ACCEPT', 'C8D8FF', '0E050E', '0E050E', 'FFF134', 'Show', '6LfzGuEZAAAAADZrHN3QDdPLYfS3I6BaKmjWjryh', 'Hide', 'banner_about.jpeg', 'banner_service.jpeg', 'banner_service_detail.jpeg', 'banner_blog.jpeg', 'banner_blog_detail.jpeg', 'banner_category.jpeg', 'banner_project.jpeg', 'banner_project_detail.jpeg', 'banner_team_member.jpeg', 'banner_team_member_detail.jpeg', 'banner_photo_gallery.jpeg', 'banner_video_gallery.jpeg', 'banner_faq.jpeg', 'banner_product.jpeg', 'banner_product_detail.jpeg', 'banner_contact.jpeg', 'banner_search.jpeg', 'banner_cart.jpeg', 'banner_checkout.jpeg', 'banner_login.jpeg', 'banner_registration.jpeg', 'banner_forget_password.jpeg', 'banner_customer_panel.jpeg', 'banner_career.jpeg', 'banner_job.jpeg', 'banner_job_application.jpeg', 'banner_term.jpeg', 'banner_privacy.jpeg', NULL, '2023-04-18 12:54:34');
...
CREATE TABLE `jobs` (
  ...
  `job_slug` text COLLATE utf8mb4_unicode_ci,
  ...
  `job_education` text COLLATE utf8mb4_unicode_ci,
  `job_experience` text COLLATE utf8mb4_unicode_ci,
  `job_additional_requirement` text COLLATE utf8mb4_unicode_ci,
  `job_benefit` text COLLATE utf8mb4_unicode_ci,
  `job_deadline` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_vacancy` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_company_name` text COLLATE utf8mb4_unicode_ci,
  `job_location` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_type` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `orders` (
  ...
  `shipping_cost` text COLLATE utf8mb4_unicode_ci,
  `coupon_code` text COLLATE utf8mb4_unicode_ci,
  `coupon_discount` text COLLATE utf8mb4_unicode_ci,
  `paid_amount` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `card_last4` text COLLATE utf8mb4_unicode_ci,
  `card_exp_month` text COLLATE utf8mb4_unicode_ci,
  `card_exp_year` text COLLATE utf8mb4_unicode_ci,
...
(1, 'Contact', '<p><br></p>', 'Show', '3153 Foley Street\r\nMiami, FL 33176', 'Office 1: 954-648-1802\r\nOffice 2: 963-612-1782', 'sales@yourwebsite.com\r\nsupport@yourwebsite.com', 'Contact Us', 'Contact Us', NULL, '2023-04-19 14:08:30');
...
CREATE TABLE `page_home_items` (
  ...
  `seo_title` text COLLATE utf8mb4_unicode_ci,
  `seo_meta_description` text COLLATE utf8mb4_unicode_ci,
  `why_choose_title` text COLLATE utf8mb4_unicode_ci,
  `why_choose_subtitle` text COLLATE utf8mb4_unicode_ci,
  `why_choose_status` text COLLATE utf8mb4_unicode_ci,
  `special_title` text COLLATE utf8mb4_unicode_ci,
  `special_subtitle` text COLLATE utf8mb4_unicode_ci,
  `special_content` text COLLATE utf8mb4_unicode_ci,
  `special_btn_text` text COLLATE utf8mb4_unicode_ci,
  `special_btn_url` text COLLATE utf8mb4_unicode_ci,
  `special_yt_video` text COLLATE utf8mb4_unicode_ci,
  `special_bg` text COLLATE utf8mb4_unicode_ci,
  `special_video_bg` text COLLATE utf8mb4_unicode_ci,
  `special_status` text COLLATE utf8mb4_unicode_ci,
  ...
  `testimonial_bg` text COLLATE utf8mb4_unicode_ci,
  `project_title` text COLLATE utf8mb4_unicode_ci,
  `project_subtitle` text COLLATE utf8mb4_unicode_ci,
  `project_status` text COLLATE utf8mb4_unicode_ci,
  `team_member_title` text COLLATE utf8mb4_unicode_ci,
  `team_member_subtitle` text COLLATE utf8mb4_unicode_ci,
  `team_member_status` text COLLATE utf8mb4_unicode_ci,
  `appointment_title` text COLLATE utf8mb4_unicode_ci,
  `appointment_text` text COLLATE utf8mb4_unicode_ci,
  `appointment_btn_text` text COLLATE utf8mb4_unicode_ci,
  `appointment_btn_url` text COLLATE utf8mb4_unicode_ci,
  `appointment_bg` text COLLATE utf8mb4_unicode_ci,
  `appointment_status` text COLLATE utf8mb4_unicode_ci,
  `latest_blog_title` text COLLATE utf8mb4_unicode_ci,
  `latest_blog_subtitle` text COLLATE utf8mb4_unicode_ci,
  `latest_blog_status` text COLLATE utf8mb4_unicode_ci,
  `newsletter_title` text COLLATE utf8mb4_unicode_ci,
  `newsletter_text` text COLLATE utf8mb4_unicode_ci,
  `newsletter_bg` text COLLATE utf8mb4_unicode_ci,
  `newsletter_status` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `photos` (
  ...
  `photo_caption` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `products` (
  ...
  `product_old_price` text COLLATE utf8mb4_unicode_ci,
  ...
  `product_return_policy` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `projects` (
  ...
  `project_slug` text COLLATE utf8mb4_unicode_ci,
  `project_content` text COLLATE utf8mb4_unicode_ci,
  `project_content_short` text COLLATE utf8mb4_unicode_ci,
  `project_start_date` text COLLATE utf8mb4_unicode_ci,
  `project_end_date` text COLLATE utf8mb4_unicode_ci,
  `project_client_name` text COLLATE utf8mb4_unicode_ci,
  `project_client_company` text COLLATE utf8mb4_unicode_ci,
  `project_client_comment` text COLLATE utf8mb4_unicode_ci,
  `project_video` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `project_photos` (
  ...
  `project_photo_caption` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `subscribers` (
  ...
  `subs_token` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `team_members` (
  ...
  `address` text COLLATE utf8mb4_unicode_ci,
  `video_youtube` text COLLATE utf8mb4_unicode_ci,
  `photo` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `seo_title` text COLLATE utf8mb4_unicode_ci,
  `seo_meta_description` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `videos` (
  ...
  `video_caption` text COLLATE utf8mb4_unicode_ci,

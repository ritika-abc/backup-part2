...
<div class="slider">
    <div class="slide-carousel owl-carousel">
        ...
        <div class="slider-item" style="background-image:url({{ asset('uploads/'.$row->slider_photo) }}); height:500px;">
            <div class="container">
                <div class="row text-dark">
                    <div class="col-md-9 col-sm-12 p-5">
                        <div class="slider-table p-5" >
                            <div class="slider-text p-5" style="background-color:black; opacity:0.6;">

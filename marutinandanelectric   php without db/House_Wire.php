    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Water Heater</h2>
                  <h3 style="color:white;">Pioneers in the industry, we offer Surya Maxx Immersion Water Heater, Surya Arctic Metal Body Water Heater, Surya Sizzle Water Heater and Surya Speedy Instant Water Heater from India.
</h3>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/havells-standard-house-wire-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                      
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="havells-standard-house-wire-500x500.webp" name="image">
                                                         <input type="hidden" value="Havells Standard House Wire" name="product">

                                                        <input type="hidden" value=" Rs 1,100 / Piece" name="price">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/rr-kabel-superex-fr-house-wire-500x500 (1).webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                         <form action="checkout.php">
                                                         <input type="hidden" value="rr-kabel-superex-fr-house-wire-500x500 (1).webp" name="image">
                                                         <input type="hidden" value="RR Kabel Superex FR House Wire" name="product">

                                                        <input type="hidden" value=" Rs 900 / Piece" name="price">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/kei-electrical-cable-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                         <form action="checkout.php">
                                                         <input type="hidden" value="kei-electrical-cable-500x500.webp" name="image">
                                                         <input type="hidden" value="KEI Homecab FR House Wire" name="product">

                                                        <input type="hidden" value=" Rs 1,020 / Piece" name="price">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">KEI Homecab FR House Wire</h4>
                                                    <h5 class="text-center"> Rs 1,020 / Roll</h5>
                                                </div>
                                            </div>
                                        </div>
                                           <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/havells-standard-wire-500x500.webp">
                                                         <div class="mask-icon">

                                                      <form action="checkout.php">
                                                         <input type="hidden" value="kei-electrical-cable-500x500.webp" name="image">
                                                         <input type="hidden" value="Havells Life Line Standard Wire" name="product">

                                                        <input type="hidden" value=" Rs 1100 / Piece" name="price">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">Havells Life Line Standard Wire</h4>
                                                    <h5 class="text-center">Rs 1,100 / Roll</h5>
                                                </div>
                                            </div>
                                  </div>
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/microteck-electric-cable-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        
                                                      <form action="checkout.php">
                                                         <input type="hidden" value="microteck-electric-cable-500x500.webp" name="image">
                                                         <input type="hidden" value="Microtek Blue House Wire" name="product">

                                                        <input type="hidden" value=" Rs 1050 / Piece" name="price">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">Microtek Blue House Wire</h4>
                                                    <h5 class="text-center"> Rs 1,050 / Roll</h5>
                                                </div>
                                            </div>
                                        </div>

                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/round-door-bell-switch-1661943612035-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                      
                                                      <form action="checkout.php">
                                                         <input type="hidden" value="round-door-bell-switch-1661943612035-500x500.webp" name="image">
                                                         <input type="hidden" value="GM GX O'Code Modular Switch" name="product">

                                                        <input type="hidden" value=" Rs 40 / Piece" name="price">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                      <form action="checkout.php">
                                                         <input type="hidden" value="gm-gx-axela-modular-switch-500x500.webp" name="image">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                         ...
                                                         <form action="checkout.php">
                                                         <input type="hidden" value="gm-cuba-modular-switches-500x500.webp" name="image">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                       ...
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="vinay-aura-black-modular-switch-500x500 (1).webp" name="image">
                                                         <input type="hidden" value="Vinay Aura Black Modular Switch" name="product">

                                                        <input type="hidden" value=" Rs 28 / Piece" name="price">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                      <form action="checkout.php">
                                                         <input type="hidden" value="schneider-electric-livia-plastic-modular-switch-500x500.webp" name="image">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <form action="checkout.php">
                                                         <input type="hidden" value="l-t-entice-modular-switch-500x500.webp" name="image">
                                                         <input type="hidden" value="L&T Entice Modular Switch" name="product">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                       ...
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="l-t-engem-modular-switch-500x500 (1).webp" name="image">
                                                         <input type="hidden" value="L&T Engem Modular Switch" name="product">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <form action="checkout.php">
                                                         <input type="hidden" value="anchor-panasonic-ziva-switch-500x500.webp" name="image">
                                                         <input type="hidden" value="Anchor Panasonic Ziva Switchs" name="product">

                                                        <input type="hidden" value=" Rs 15 / Piece" name="price">
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                       ...
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="philips-elite-modular-switches-500x500 (1).webp" name="image">
                                                         <input type="hidden" value="Philips Elite Modular Switches" name="product">

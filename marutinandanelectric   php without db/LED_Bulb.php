    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>LED Bulb</h2>
                  <h3 style="color:white;">Offering you a complete choice of products which include 15W Halonix Photon Plus LED Bulb, 20W Halonix Astron Plus LED Bulb and 12W Halonix Astron Plus LED Bulb.
</h3>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/door-bell-switch-500x500 (2).webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                      
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="door-bell-switch-500x500 (2).webp" name="image">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/bulb-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                         <form action="checkout.php">
                                                         <input type="hidden" value="bulb-500x500.webp" name="image">
                                                         <input type="hidden" value="20W Halonix Astron Plus LED Bulb" name="product">

                                                        <input type="hidden" value=" Rs 240 / Piece" name="price">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">20W Halonix Astron Plus LED Bulb</h4>
                                                    <h5 class="text-center">Rs 240 / Piece</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/helonix-bulb-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        
                                                         <form action="checkout.php">
                                                         <input type="hidden" value="helonix-bulb-500x500.webp" name="image">
                                                         <input type="hidden" value="12W Halonix Astron Plus LED Bulb" name="product">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">12W Halonix Astron Plus LED Bulb</h4>
                                                    <h5 class="text-center"> Rs 130 / Piece</h5>
                                                </div>
                                            </div>
                                        </div>

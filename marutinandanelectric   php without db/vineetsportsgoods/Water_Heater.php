                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/surya-maxx-immersion-water-heater-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                      <form action="checkout.php">
                                                         <input type="hidden" value="surya-maxx-immersion-water-heater-500x500.webp" name="image">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/surya-arctic-metal-body-water-heater-500x500 (1).webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="surya-arctic-metal-body-water-heater-500x500 (1).webp" name="image">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/surya-speedy-instant-water-heater-500x500.webp" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        
                                                       <form action="checkout.php">
                                                         <input type="hidden" value="surya-speedy-instant-water-heater-500x500.webp" name="image">
                                                         <input type="hidden" value="Surya Speedy Instant Water Heater" name="product">

                                                        <input type="hidden" value=" Rs 6000 / Piece" name="price">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h4 class="text-center">Surya Speedy Instant Water Heater</h4>
                                                    <h5 class="text-center"> Rs 6000 / Piece</h5>
                                                </div>
                                            </div>
                                        </div>

...
CREATE TABLE `leads` (
  `id` int(10) UNSIGNED NOT NULL,
  `lead_for` varchar(255) DEFAULT NULL,
  ...
  `pagerequest` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `locations` (
  ...
  `short_description` text DEFAULT NULL,
  `description` text DEFAULT NULL,
  `meta_schema` varchar(255) DEFAULT NULL,
...
(1, 'admin', 'admin', 'admin', 'a465b6e05a5dee36c7370b6b8bed5cbc015b1cb0', 1, '2011-09-26 00:34:07', '2024-05-10 12:46:01');

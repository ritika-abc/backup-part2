...
<div class="breadcrumb-title pr-3">Subdomains</div>
<div class="pl-3">
<nav aria-label="breadcrumb">
<ol class="breadcrumb mb-0 p-0">

<li class="breadcrumb-item active" aria-current="page">Subdomain Details</li>
</ol>
</nav>
</div>
<div class="ml-auto">
<div class="btn-group">
<?php 
echo $this->Html->link("<i class=\"icon-plus\"></i>Manage subdomains",
...
<hr/>
<?php echo $this->Form->create('Subdomain',array('enctype'=>'multipart/form-data'));
...
<label class="col-sm-2 col-form-label">Subdomain Name</label>
<div class="col-sm-10"> <?php echo $this->Form->input('name', array('class'=>'form-control','label'=>''));?> </div>
</div>
<?php

$thumbImageurl = $this->Html->url('/images/subdomains/'.$this->data['Subdomain']['image']);
$Imageurl = "/images/noimage.png";

$Imageurl = ($this->data['Subdomain']['image'] != '')?$thumbImageurl:$Imageurl;
?>

<div class="form-group row">
<label class="col-sm-2 col-form-label">Subdomain Image</label>
<div class="col-sm-6"> 
<input type="file" class="form-control" name="data[Subdomain][image]" id="BannerThumb">
...
<div class="col-sm-10">
  ...
  [Product Name - product]  [Location Name - subdomain ]

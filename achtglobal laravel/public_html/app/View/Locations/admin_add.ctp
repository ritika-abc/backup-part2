...
<div class="breadcrumb-title pr-3">Locations</div>
<div class="pl-3">
...
<div class="btn-group">
<?php 
echo $this->Html->link("<i class=\"icon-plus\"></i>Manage Locations",
...
<hr/>
<?php
echo $this->Form->create('Location',array('enctype'=>'multipart/form-data','class' => 'form-horizontal'));
?>
<div class="form-body">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Select Parent Location</label>
<div class="col-sm-10"><?php echo $this->Form->input('parent_id', array('options' => $parentlocations,'class'=>'form-control single-select','label'=>'','empty' => true));?>	
</div>
</div>
...
?>
<div class="form-group row">
<label class="col-sm-2 col-form-label">Location Image</label>
<div class="col-sm-10"> 
<input type="file" class="form-control" name="data[Location][image]" id="BannerThumb">

...
<div class="breadcrumb-title pr-3">Galleries</div>
<div class="pl-3">
...
<div class="btn-group">
<?php 
echo $this->Html->link("<i class=\"icon-plus\"></i>Manage Galleries",
...
<hr/>
<?php
echo $this->Form->create('Gallery',array('enctype'=>'multipart/form-data','class' => 'form-horizontal'));
?>
<div class="form-body">
...
<div class="col-sm-10"><?php echo $this->Form->input('product_id', array('options' => $products,'class'=>'form-control  single-select','label'=>'','empty' => true));?>	
</div>
</div>
...
<div class="col-sm-10"> 
<input type="file" class="form-control" name="data[Gallery][image]" id="BannerThumb">
...
array( 'controller' => 'galleries', 'action' => 'index', 'admin' => true),

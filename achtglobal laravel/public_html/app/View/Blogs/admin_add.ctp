...
<div class="btn-group">
<?php 
echo $this->Html->link("<i class=\"icon-plus\"></i>Manage Blogs",
...
<hr/>
<?php
echo $this->Form->create('Blog',array('enctype'=>'multipart/form-data','class' => 'form-horizontal'));
?>
<div class="form-body">
...
<div class="col-sm-10"> 
<input type="file" class="form-control" name="data[Blog][image]" id="BannerThumb">

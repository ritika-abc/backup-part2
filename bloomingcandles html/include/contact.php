...
<div class="container ">
  ...
  <div class="p-5">
    ...
    <div class="form p-5">
      <h4>GET IN TOUCH</h4>
      <h2 class="form-headline">Send  your requirement to us.</h2>
      <form id="submit-form" action="">
        ...
        <p>
          <input id="email" class="form-input" type="number" placeholder="Your Phone Number*">
          <small class="name-error"></small>
        </p>
        <p class="">
        ...
        <p class="full-width">
          <textarea  minlength="20" id="message" cols="30" rows="4" placeholder="Your Message*" required></textarea>
          <small></small>
        </p>
        <p class="full-width">
